         ...
         <ul>
            {detailsTrip && (
               <li>
                  ...
                  <p className="top">Name: {detailsTrip.trip.name}</p>
                  <p className="top1">Planet: {detailsTrip.trip.planet}</p>
                  <p className="top2">Description: {detailsTrip.trip.description}</p>
                  <p className="top3"> Date: {detailsTrip.trip.date}</p>
                  <p className="top4"> Duration: {detailsTrip.trip.durationInDays}</p>
               </li>
            )}
            <div>
               <div>
